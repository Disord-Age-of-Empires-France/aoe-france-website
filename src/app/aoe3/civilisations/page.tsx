...
export const metadata = { title: "Civilisations — Age of Empires III : DE" };

export default async function Aoe3CivilisationsPage() {
    ...
    <>
      ...
      <main className="flex-1 pt-28 pb-16 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <p className="text-[#c8a32e] text-xs font-bold tracking-[0.3em] mb-2">AGE OF EMPIRES III : DE</p>
            ...
            <p className="text-muted text-sm">
              {civs.length > 0
                ? `${civs.length} civilisation${civs.length > 1 ? "s" : ""}${civs.some(c => c.dlc) ? " (DLC inclus)" : ""}`
          ...
          <CivsGrid
            ...
            basePath="/aoe3/civilisations"
            groupBy={c => c.dlc ?? "Jeu de base"}
          />
        </div>
      </main>
      <Footer />
