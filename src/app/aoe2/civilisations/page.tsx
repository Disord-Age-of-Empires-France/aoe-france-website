...
export const metadata = { title: "Civilisations — Age of Empires II : DE" };

export default async function Aoe2CivilisationsPage() {
    ...
    <>
      ...
      <main className="flex-1 pt-28 pb-16 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <p className="text-[#c8a32e] text-xs font-bold tracking-[0.3em] mb-2">AGE OF EMPIRES II : DE</p>
          ...
          <CivsGrid civs={civs} emptyLabel="Aucune civilisation trouvée." basePath="/aoe2/civilisations" />
        </div>
      </main>
      <Footer />
    </>
